...
validCounter = 0
formatedData = text.splitlines()

# for data in formatedData:
#     minletter = int(data.split()[0].split('-')[0])
#     maxletter = int(data.split()[0].split('-')[1])
#     letter = data.split()[1][0]
...
for data in formatedData:
    position1 = int(data.split()[0].split('-')[0])
    position2 = int(data.split()[0].split('-')[1])
    letter = data.split()[1][0]
    password = data.split()[2]

    if((password[position1-1] + password[position2-1]).count(letter) == 1):
        validCounter += 1
